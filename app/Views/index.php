...
<body>
      ...
      <div class="row">
        <div class="col-md-3 col-sm-3 col-xs-12 pdl0">
          <a href="#" class="menu23">
            <div class="menu23-content">
              <img class="lazy widthyuz" src="assets/images/biletsorgula_icon1.png"
                style="float: left;width: 27% !important;display: block;height: 27%;object-fit: contain;" alt="">
              <h4>Bilet İşlemleri</h4>
              <p>Bilet işlemlerinizi online olarak hızlı ve kolay şekilde gerçekleştirebilir; biletinizi değiştirebilir,
                açığa alabilir ve iptal edebilirsiniz.</p>
            </div>
          </a>
        </div>
        <div class="col-md-3 col-sm-3 col-xs-12">
          <a href="#" class="menu23 delayuc">
            <div class="menu23-content">
              <img class="" src="assets/images/yanmazbilet_icon3.png"
                style="float: left;width: 27% !important;display: block;height: 27%;margin-top: -3.5%;object-fit: contain;"
                alt="">
              <h4>Yanmaz Bilet</h4>
              <p>Biletinizi, ek ücret ödeyerek Yanmaz Bilet'e dönüştürebilirsiniz. Avantajlar ve koşullar hakkında
                detaylı bilgi için tıklayınız.</p>
            </div>
          </a>
        </div>
        <div class="col-md-3 col-sm-3 col-xs-12">
          <a href="#" target=_blank class="menu23 delayuc">
            <div class="menu23-content">
              <img class="" src="assets/images/pamukkalekargo_logo.png"
                style="float: left;width: 27% !important;display: block;height: 27%;object-fit: contain;" alt="">
              <h4>Umuttepe Kargo</h4>
              <p>Kargonuz, saatler içinde olması gereken yerde olacak. Umuttepe Turizm tecrübesi ve kalitesiyle
                kargonuzu hızlı bir şekilde zamanında ulaştırıyoruz.</p>
        ...
        <div class="col-md-3 col-sm-3 col-xs-12">
          <a href="#" class="menu23 delayuc">
            <div class="menu23-content">
              <img class="" src="assets/images/acikbilet_icon3.png"
                style="float: left;width: 27% !important;display: block;height: 27%;object-fit: contain;" alt="">
              <h4>Açık Bilet</h4>
              <p>Açık Bilet sayesinde satın aldığınız biletinizi değişen fiyatlardan etkilenmeden dilediğiniz tarihte
                dilediğiniz sefere kullanabilirsiniz.</p>
            </div>
          </a>
        </div>
      </div>
        ...
        <div class="col-md-12 pd0 text-center">
          <div class="bus-features-main">
            <div class="bus-features-box delayalti">
              ...
              <div class="animated fadeIn featuredtext" style="font-size: 13px;margin-top: 2.5%;">Tüm seferlerimizde
                açık büfe ikram servisimiz bulunmaktadır.</div>
            </div>
            <div class="bus-features-box delaysifir">
              <img src="assets/images/icon/buyukekran.png" alt="">
              <div class="animated fadeIn featuredtext" style="font-size: 13px;">10" HD Ekran ile film, canlı TV
                izleyebilme ve internete erişim sağlayabilme imkanı.</div>
            </div>
            <div class="bus-features-box delayiki">
              <img src="assets/images/icon/internet.png" alt="">
              <div class="animated fadeIn featuredtext" style="font-size: 13px;">Tüm otobüslerimizde bulunan Wifi
                hizmeti ile yolculuk boyunca internet imkanı</div>
            </div>
            <div class="bus-features-box delayalti">
              <img src="assets/images/icon/priz.png" alt="">
              <div class="animated fadeIn featuredtext" style="font-size: 13px;margin-top: -2%;">Tüm otobüslerimizde
                bulunan 220 Volt priz ile yolculuk boyunca cihazlarınızı şarjı bitmeden kullanabilirsiniz</div>
            </div>
            <div class="bus-features-box delaysekiz">
              <img src="assets/images/icon/android.png" alt="">
              <div class="animated fadeIn featuredtext" style="font-size: 13px;margin-top: -2%;">Android ekranlar ile
                internete bağlanarak ve kişisel arşivlerinize ulaşarak yolculuğunuzun keyfini sürebilirsiniz.</div>
            </div>
            <div class="bus-features-box delaybin">
              <img src="assets/images/icon/usb.png" alt="">
              <div class="animated fadeIn featuredtext" style="font-size: 13px;margin-top: -2%;">Otobüslerimizde bulunan
                USB girişleri ile kişisel verilerinize ulaşabilir ve telefonlarınızı şarj edebilirsiniz.</div>
            </div>
          </div>
          <hr>
        </div>
        ...
        <div class="phone-fade2">
          <h1 style=" display:inline-block;"><img src="assets/images/724_biletal1.png" alt="">
            <h1 style=" display:inline-block;">
              <p style=" display:inline-block;">Otobüs Bileti Almanın<br>En Kolay Yolu</p>
            </h1>
            ...
            <p>
              <a href="https://play.google.com/store" target=_blank><img data-original="assets/images/googleplay.png"
                  src="assets/images/googleplay.png" alt="" class="lazy mt10"></a>
              <a href="https://www.apple.com/tr/app-store/" target=_blank><img
                  data-original="assets/images/applestore.png" src="assets/images/applestore.png" alt=""
                  class="lazy mt10"></a>
              <a href="https://consumer.huawei.com/tr/mobileservices/appgallery/" target=_blank><img
                  data-original="assets/images/huawei1.png" src="assets/images/huawei1.png" alt=""
                  style="max-height: 40px;" class="lazy mt10 imgsize2"></a>
  ...
  <script async
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD4mDWGu_NvFgAcY6c3p8OoHHpkOEs_NcE&callback=console.debug&libraries=maps,marker&v=beta"></script>
</body>
